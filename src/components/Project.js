...
//   return (
//     <div>
//       <nav style={{border:'1px solid black',marginBottom:'40px',backgroundColor:'lightblue'}}>
//         <Button variant="contained" color="primary" onClick={handleDialogOpen} sx={{margin:'5px 0 5px 5px'}}>
//           Buy Now
//         </Button>
//       </nav>
...
//               />
//             </Grid>
//             <Grid item xs={12} style={{textAlign:'center',marginLeft:'50px'}}>
//               <input
//                 type="file"
//                 accept="image/*"
